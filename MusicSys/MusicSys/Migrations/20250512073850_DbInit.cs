    ...
    public partial class DbInit : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AlbumArtists", x => new { x.AlbumsAlbumId, x.ArtistsArtistId });
                    table.ForeignKey(
                        name: "FK_AlbumArtists_Albums_AlbumsAlbumId",
                        column: x => x.AlbumsAlbumId,
                        principalTable: "Albums",
                        principalColumn: "AlbumId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AlbumArtists_Artists_ArtistsArtistId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AlbumArtists_ArtistsArtistId",
                table: "AlbumArtists",
